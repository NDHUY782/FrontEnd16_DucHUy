...
//     },false)
    const ELEMENT_TEXT = document.getElementsByClassName('container');
     const text =['có làm mưới có ăn','không làm mà đòi có ăn','thì ăn năn xám hối']
     let counter = 0;
     function change() {
        ELEMENT_TEXT.innerHTML = text(counter);
        counter++;
